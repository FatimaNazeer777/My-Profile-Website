    ...
    <section className="text-white body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p
            className="mb-8 leading-relaxed ml-10"
            data-aos="fade-up"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="1500"
          >
            I am a web developer and BBA student, exploring the intersection of
            business and technology through cloud-applied generative AI
            engineering. My journey is about mastering the latest AI tools to
            enhance web development and drive business innovation.
          </p>
        ...
        <div
          className="lg:max-w-lg lg:w-full md:w-1/2 w-5/5"
          data-aos="flip-down"
