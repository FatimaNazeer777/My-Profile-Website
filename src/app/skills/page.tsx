      ...
      <div className="container px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          <SkillCard
            ...
            svgIcon={<FaHtml5 size={80} className="bg-orange-500 rounded-full animate-pulse" />}
            dataAos="fade-up"
          />
          <SkillCard
            title="CSS"
            ...
            svgIcon={<FaCss3Alt size={80} className="bg-blue-300 rounded-full animate-spin" />}
            dataAos="fade-left"
            dataAosDelay="100"
          />
          <SkillCard
            ...
            svgIcon={<SiTailwindcss size={80} className="bg-teal-300 rounded-full animate-bounce" />}
            dataAos="fade-right"
            dataAosDelay="200"
          />
          <SkillCard
            ...
            svgIcon={<FaJsSquare size={80} className="bg-yellow-400 rounded-full animate-pulse" />}
            dataAos="zoom-in"
            dataAosDelay="300"
          />
          <SkillCard
            ...
            svgIcon={<SiTypescript size={80} className="bg-blue-500 rounded-full animate-spin" />}
            dataAos="flip-left"
            dataAosDelay="400"
          />
          <SkillCard
            ...
            svgIcon={<FaReact size={80} className="bg-blue-200 rounded-full animate-bounce" />}
            dataAos="flip-right"
            dataAosDelay="500"
          />
          <SkillCard
          ...
          <SkillCard
            ...
            svgIcon={<FaNodeJs size={80} className="bg-green-400 rounded-full animate-spin" />}
            dataAos="slide-down"
            dataAosDelay="700"
          />
        </div>
